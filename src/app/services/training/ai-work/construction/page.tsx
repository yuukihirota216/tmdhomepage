...
export const metadata: Metadata = {
  title: '生成AI 業務活用研修（建設業向け） | 有限会社TMD（creationラボ）',
  description: '建設業界の業務に特化したAI活用研修を準備中です。現場管理、積算、図面作成など建設業特有の課題を解決します。',
  openGraph: {
    title: '生成AI 業務活用研修（建設業向け） | 有限会社TMD（creationラボ）',
    description: '建設業界の業務に特化したAI活用研修を準備中です。現場管理、積算、図面作成など建設業特有の課題を解決します。',
    type: 'website',
  ...
  alternates: {
    canonical: 'https://tmd-creation-lab.com/services/training/ai-work/construction',
  },
};
...
export default function ConstructionTrainingPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-8">
              建設業界特有の業務課題に特化したAI活用研修を開発中です。
              現場管理、積算、安全管理など、建設業の実務に直結する内容を予定しています。
            </p>
            <Link href="/contact">
            ...
            <CardContent className="p-8">
              ...
              <div className="mt-8 p-6 bg-orange-50 rounded-lg">
                <p className="text-gray-700 text-center">
                  ...
                  建設業界のお客様のご意見を参考に、より実践的な研修内容を開発しています。
                </p>
              </div>
            </CardContent>
          </Card>
      ...
      <section className="nexus-section-padding bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            建設業向け研修の開発にあたり、業界の皆様のご意見をお聞かせください。
